...
contract StakeTokensTest is Test {
    ...
    // Test unstaking with auto-compound set to false
    function testUnstakeAutoCompoundFalse() public {
        vm.startPrank(user);
        stakeTokens.stake(address(token0), stakeAmount, false);
    ...
    function testUnstakeAutoCompoundTwoPeriodFalse() public {
        vm.startPrank(user);
        stakeTokens.stake(address(token0), stakeAmount, false);
    ...
    function testUnstakeAutoCompoundThreePeriodFalse() public {
        vm.startPrank(user);
        stakeTokens.stake(address(token0), stakeAmount, false);
    ...
    function testUnstakeAutoCompoundTrue() public {
        vm.startPrank(user);
    ...
    function testUnstakeAutoCompoundTwoPeriodTrue() public {
        vm.startPrank(user);
        stakeTokens.stake(address(token0), stakeAmount, true);
        ...
        // Calculate the expected reward using the compound interest formula
        uint256 expectedReward = compoundInterest(stakeAmount, token0APY, 2, true); // Assuming 1 year of compounding, autoCompound true
    ...
    function testUnstakeAutoCompoundThreePeriodTrue() public {
        vm.startPrank(user);
        stakeTokens.stake(address(token0), stakeAmount, true);
        ...
        // Calculate the expected reward using the compound interest formula
        uint256 expectedReward = compoundInterest(stakeAmount, token0APY, 3, true); // Assuming 1 year of compounding, autoCompound true
